...
Note that if the user explicitly marks a task as "unscheduled", then the
start-date of such task is always set to today. This means it overwrites 
start-dates that might be implicitly given due to (non-)logic dependencies
or even explicitly defined start date. 
