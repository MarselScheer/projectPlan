...
Especially at the beginning of a project when the plan is growing it could be handy to have one id for more than one task. 
Using the same *id* within the same *section* is possible. If this happens, then the corresponding rows get are combined
