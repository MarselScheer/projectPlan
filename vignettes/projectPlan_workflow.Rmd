...
* status can be empty or contain the special terms AWAIT or ABORTED. 
...
has status *AWAIT*. We set the progress 
...
created for task in status *AWAIT*, where the estimated end of the task is used as the date for
