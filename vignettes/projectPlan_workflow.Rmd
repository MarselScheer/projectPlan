...
raw_plan <- "./inst/template/projects.xlsx" %>%
...
```{r echo=FALSE}
raw_plan$deadline[nrow(raw_plan)] <- as.character(lubridate::as_date(lubridate::now()) + 40)
```
...
sell_kitchen <- structure(list(
  ...
  status = c("unscheduled", "unscheduled", "unscheduled", "unscheduled"),
  resource = c(
    "I",
    "I", "I", "I, buyer"
...
debugonce(projectPlan::wrangle_raw_plan)
