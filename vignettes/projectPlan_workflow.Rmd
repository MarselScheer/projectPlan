...
raw_plan <- structure(list(
  section = c(
    ...
    NA, NA, NA, NA, 17956), class = "Date"), project = c(
...
Assume that we started 3 week ago and we updated the spreadsheet over the time. We already completed 
...
after importing the spreadsheet might look like this:
...
Assume that we alread planned our new kitchen with Mrs. Gray and we already have an appointment for the
...
sell_kitchen <- structure(list(
  section = c("0_prep", "0_prep", "0_prep", "1_pickup"), id = c("pictures", "offer", "tours", "sell"), task = c(
    ...
    NA_character_, NA_character_
  ), end = c(NA, 1, 20, 1), resource = c(
    "I",
    "I", "I", NA
  ), progress = c(0, 0, 0, NA), deadline = structure(c(
    NA_real_,
