...
raw_plan <- data.table::rbindlist(
  list(
    ...
    data.table(
      ...
      task = c("T3", "T4"),
      progress = c(0, 0),
      deadline = c("2018-11-05", "2018-11-14")
    )
  )
)
...
is adjusted for weekends, for instance *T3* will be done by Thrusday night and the deadline is on the 
following Monday. Hence, there is one day left, i.e. Friday, before the deadline is reached.
